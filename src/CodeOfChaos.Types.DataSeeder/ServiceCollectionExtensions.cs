...
public static class ServiceCollectionExtensions {
    ...
    /// The type of the data seeder to be added. Must implement both <see cref="IDataSeederService"/> and <see cref="IHostedService"/>.
    /// </typeparam>
    /// <param name="services">
    ...
    /// <summary>
    /// Registers a one-time data seeder of type <typeparamref name="TDataSeeder"/> in the service collection using a factory function.
    /// </summary>
    /// <typeparam name="TDataSeeder">
    /// The type of the data seeder to register. Must implement both <see cref="IDataSeederService"/> and <see cref="IHostedService"/>.
    /// </typeparam>
    /// <param name="services">
    /// The <see cref="IServiceCollection"/> instance to which the data seeder will be added.
    /// </param>
    ...
    /// An <see cref="Action{T}"/> delegate to configure the <see cref="OneTimeDataSeederService"/> or a custom seeder service.
    /// </param>
    /// <returns>
    /// The updated <see cref="IServiceCollection"/> with the registered one-time data seeder service.
    /// </returns>
    ...
    /// <summary>
    /// Adds a one-time data seeder to the service collection with the ability to configure it via a provided configuration action.
    /// </summary>
    /// <typeparam name="TDataSeeder">The type of the data seeder to be added, which must implement <see cref="IDataSeederService"/> and <see cref="IHostedService"/>.</typeparam>
